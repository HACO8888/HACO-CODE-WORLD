...
- title: All in English
  details: Learning programs in English is not a problem at all, so that people who still don't understand English can enjoy the joy of learning programs.
- title: Clear Views
  details: Teach you to write programs with concise vocabulary and pictures, so that everyone can quickly understand the program and immersed in the program.
- title: Only One
  details: The only teaching website with complete teaching in Taiwan, people who still don't understand code can look over here for complete teaching.
