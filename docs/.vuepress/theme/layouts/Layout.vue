		...
		<div class="content-wrapper">
			<Notifications>
				<Notification storage-key="v13-notice">
					...
					<span>
						感謝您造訪我們全新的網站，參觀之餘也別忘了詳讀我們的使用者 <router-link to="/privacy-and-policy/">隱私權政策</router-link>！也請記得加入我們的Discord群組喔！<a href="https://discord.gg/unlimited-play" target="_blanket">點我加入</a>
					</span>
				</Notification>
			</Notifications>
